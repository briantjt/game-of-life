require_relative '../../lib/multi/world_multi.rb'
...
RSpec.describe 'World class' do
  context 'World creation' do
    it 'Creates a matrix of n length' do
      ...
      world = WorldMulti.new(matrix, 10, 1)
  ...
  context 'Game state advancement' do
    before :example do
      ...
      @world = WorldMulti.new(matrix, 3, 1)
    end
  ...
  it 'Generates the correct string representation' do
    ...
    world1 = WorldMulti.new(matrix1, 3, 1)
    world2 = WorldMulti.new(matrix2, 3, 1)
